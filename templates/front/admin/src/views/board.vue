		...
		<div :style='{"padding":"0px 20px 0","display":"flex","height":"calc(100vh - 0px)"}'>
			<div :style='{"width":"28%","padding":"30px 10px 0 0","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="meishixinxiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="meishixinxiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="meishixinxiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"flex-start","padding":"0px","margin":"0 0 20px","color":"#fff","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","justifyContent":"center","height":"calc(32% - 40px)","order":"2"}'>
					...
					<div :style='{"margin":"0 20px 0 0 ","alignItems":"center","borderRadius":"100%","background":"rgba(255,255,255,.2)","flexDirection":"column","display":"flex","width":"130px","position":"relative","justifyContent":"center","height":"130px"}'>
						...
						<div :style='{"padding":"0","margin":"20px 0 0","alignItems":"center","textAlign":"center","flexDirection":"column","display":"block","justifyContent":"space-between"}'>
							<div :style='{"lineHeight":"auto","fontSize":"inherit","color":"inherit","height":"auto"}'>菜谱信息总数</div>
							<div :style='{"lineHeight":"40px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"auto"}'>{{caipuxinxiCount}}</div>
						</div>
					</div>
					...
					<div :style='{"margin":"0 20px 0 0 ","alignItems":"center","borderRadius":"100%","background":"rgba(255,255,255,.2)","flexDirection":"column","display":"flex","width":"130px","position":"relative","justifyContent":"center","height":"130px"}'>
						...
						<div :style='{"padding":"0","margin":"10px 0 0","alignItems":"center","textAlign":"center","flexDirection":"column","display":"block","justifyContent":"space-between"}'>
							<div :style='{"lineHeight":"auto","fontSize":"inherit","color":"inherit","height":"auto"}'>美食信息总数</div>
							<div :style='{"lineHeight":"auto","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"auto"}'>{{meishixinxiCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"padding":"0 0 0 60px","margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","width":"100%","lineHeight":"42px","fontSize":"16px","height":"42px"}'>美食信息</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"padding":"0","borderColor":"#044bbe","borderWidth":"1px 0 0 1px","background":"none","width":"100%","borderStyle":"solid","zIndex":"9"}'>
						<el-table-column :resizable="true" :sortable="false" prop="name" label="菜谱名"/>
						</el-table-column>
						...
						<el-table-column :resizable="true" :sortable="false" prop="view" label="浏览量"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="collect" label="收藏量"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"28%","padding":"30px 0 0 10px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","height":"85%","zIndex":"9"}'>
						<div id="caipuxinxiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"width":"100%","padding":"0 0 0 60px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231222/6b6d1211d4614868b2253cd91924db42.png) no-repeat center top /100% 100%","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="caipuxinxiChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
  ...
  created() {
    this.$nextTick(()=>{
		...
		setTimeout(()=>{
			...
			this.caipuxinxiChat4();
			this.caipuxinxiChat5();
...
//统计接口1
    caipuxinxiChat4() {
      this.$nextTick(()=>{
        ...
        var caipuxinxiChart4 = echarts.init(document.getElementById("caipuxinxiChart4"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                caipuxinxiChart4.setOption(option);
				

                  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
                    caipuxinxiChart4.resize();
                },false);
            }
        });
      })
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'caipuxinxiChart5');
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, meishixinxiChart2)
